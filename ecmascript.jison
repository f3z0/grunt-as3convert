/*
jison-as3 is distributed under GPL license reproduced below.
...
"public"                        return "ACCESSOR";
"private"                        return "ACCESSOR";
"protected"                        return "ACCESSOR";
"internal"                        return "ACCESSOR";
...
: "IMPORT" "IDENTIFIER" ";"
    {
        $$ = new ImportStatementNode($2, createSourceLocation(null, @1, @2));
    }
;

VariableStatement
    : "ACCESSOR" "VAR" VariableDeclarationList ";"
        {
            $$ = new VariableDeclarationNode($3, "var", createSourceLocation(null, @1, @3));
        }
...
VariableDeclarationNoIn
    ...
    | "IDENTIFIER"  "VAR_TYPE" InitialiserNoIn
        {
            $$ = new VariableDeclaratorNode(new IdentifierNode($1, createSourceLocation(null, @1, @1)), $3, createSourceLocation(null, @1, @3));
        }
    | "IDENTIFIER"
...
PackageStatement
    : "PACKAGE" "IDENTIFIER" "{" FunctionBody "}"
        {
        $$ = new PackageDeclarationNode(new IdentifierNode($2, createSourceLocation(null, @2, @2)), [], $4, false, false, createSourceLocation(null, @1, @5));
        }
    ;

ClassStatement
    : "ACCESSOR" "CLASS" "IDENTIFIER" "EXTENDS" "IDENTIFIER" "{" FunctionBody "}"
       {
       $$ = new ClassDeclarationNode(new IdentifierNode($3, createSourceLocation(null, @3, @3)), [], $7, false, false, createSourceLocation(null, @1, @8));
       }
    ;

OverrideDeclarative
    : "OVERRIDE"  "ACCESSOR" FunctionDeclaration
       {
       $$ = $3;
       }
...
FunctionDeclaration
    ...
    | "FUNCTION" "IDENTIFIER" "(" ")" "VAR_TYPE" "{" FunctionBody "}"
        {
        $$ = new FunctionDeclarationNode(new IdentifierNode($2, createSourceLocation(null, @2, @2)), [], $7, false, false, createSourceLocation(null, @1, @8));
        }
    | "FUNCTION" "IDENTIFIER" "(" FormalParameterList ")" "VAR_TYPE" "{" FunctionBody "}"
        {
        $$ = new FunctionDeclarationNode(new IdentifierNode($2, createSourceLocation(null, @2, @2)), $4, $8, false, false, createSourceLocation(null, @1, @9));
        }
    | "FUNCTION"  "GETSET" "IDENTIFIER" "(" ")" "{" FunctionBody "}"
        {
        $$ = new FunctionDeclarationNode(new IdentifierNode($3, createSourceLocation(null, @3, @3)), [], $7, false, false, createSourceLocation(null, @1, @8));
        }
    | "FUNCTION"  "GETSET" "IDENTIFIER" "(" FormalParameterList ")" "{" FunctionBody "}"
        {
        $$ = new FunctionDeclarationNode(new IdentifierNode($3, createSourceLocation(null, @3, @3)), $5, $8, false, false, createSourceLocation(null, @1, @9));
        }
    | "FUNCTION"  "GETSET" "IDENTIFIER" "(" ")" "VAR_TYPE" "{" FunctionBody "}"
        {
        $$ = new FunctionDeclarationNode(new IdentifierNode($3, createSourceLocation(null, @3, @3)), [], $8, false, false, createSourceLocation(null, @1, @9));
        }
    | "FUNCTION"  "GETSET" "IDENTIFIER" "(" FormalParameterList ")" "VAR_TYPE" "{" FunctionBody "}"
        {
        $$ = new FunctionDeclarationNode(new IdentifierNode($3, createSourceLocation(null, @3, @3)), $5, $9, false, false, createSourceLocation(null, @1, @10));
        }
    ;
...
FormalParameterList
    : "IDENTIFIER" "VAR_TYPE"
        {
            $$ = [new IdentifierNode($1, createSourceLocation(null, @1, @2))];
        }
    | FormalParameterList "," "IDENTIFIER" "VAR_TYPE"
        {
            $$ = $1.concat(new IdentifierNode($3, createSourceLocation(null, @4, @4)));
        }
    | "IDENTIFIER"
        {
    ...
    | "IDENTIFIER" "VAR_TYPE" "=" Literal
        {
            $$ = [new IdentifierNode($1, createSourceLocation(null, @4, @4))];
        }
    | FormalParameterList "," "IDENTIFIER" "VAR_TYPE" "=" Literal
        {
            $$ = $1.concat(new IdentifierNode($3, createSourceLocation(null, @6, @6)));
        }
    | "IDENTIFIER" "=" Literal
        {
            $$ = [new IdentifierNode($1, createSourceLocation(null, @3, @3))];
        }
    | FormalParameterList "," "IDENTIFIER" "=" Literal
        {
            $$ = $1.concat(new IdentifierNode($3, createSourceLocation(null, @5, @5)));
        }
    ;
...
Expression
    ...
    | Expression "," AssignmentExpression "AS" "IDENTIFIER"
        {
...
ExpressionNoIn
    ...
    | AssignmentExpressionNoIn "AS" "IDENTIFIER"
    | ExpressionNoIn "," AssignmentExpressionNoIn "AS" "IDENTIFIER"
        {
            if ($1.type === "SequenceExpression") {
                $1.expressions.concat($3);
                $1.loc = createSourceLocation(null, @1, @3);
...
ExpressionNoBF
    ...
    | AssignmentExpressionNoBF "AS" "IDENTIFIER"
    | ExpressionNoBF "," AssignmentExpression "AS" "IDENTIFIER"
        {
            if ($1.type === "SequenceExpression") {
                $1.expressions.concat($3);
                $1.loc = createSourceLocation(null, @1, @3);
