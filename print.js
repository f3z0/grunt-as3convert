...
(function(parser) {
	...
	ast.ImportStatementNode.prototype.print = function(indent, indentChar) {
		return indent + "//import " + this.ns + ";";
	};
	...
	ast.BlockStatementNode.prototype.print = function(indent, indentChar) {
		...
		for (var i = 0, len = statements.length; i < len; i++) {
			if(typeof statements[i].print !== 'undefined') str += statements[i].print(newIndent, indentChar) + "\n";
		}
	...
	ast.PackageDeclarationNode.prototype.print = function(indent, indentChar) {
		...
		for (var i = 0, len = body.length; i < len; i++) {
			if(typeof body[i].print !== 'undefined') str += body[i].print(newIndent, indentChar) + "\n";
		}

		return str + indent + "});";
	}

	ast.ClassDeclarationNode.prototype.print = function(indent, indentChar) {
		var str = ast.FunctionDeclarationNode.prototype.print.apply(this, arguments) + '\n';
		str += indent + "return " + this.id.print("", "") + ';';
		return str;
	}
	...
	ast.FunctionDeclarationNode.prototype.print = function(indent, indentChar) {
		...
		for (var i = 0, len = params.length; i < len; i++) {
			...
			if(typeof params[i].print !== 'undefined') str += params[i].print(newIndent, indentChar);
		}
